...
- [**Карта развития Back-end разработчика:**](#Карта-развития-back-end-разработчика-)
    ...
    - [Другой вариант карты](https://roadmap.sh/backend)
...
- [**Карта развития Front-end разработчика:**](#Карта-развития-front-end-разработчика-)
    ...
    - [Другой вариант карты](https://roadmap.sh/frontend)

- [**Карта развития DevOps-инженера:**]
    - [Карта](https://roadmap.sh/devops)
